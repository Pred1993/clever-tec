import {utilGetWeekNumber} from './util-get-week-number';

type UtilCreateDateType = {
    locale?: string
    date?: Date
}

export const utilCreateDate = (params?: UtilCreateDateType) => {
    ...
    const week = utilGetWeekNumber(d);
