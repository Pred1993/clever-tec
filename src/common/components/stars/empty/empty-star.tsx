...
import styles from './empty-star.module.scss';
...
export const EmptyStar: FC<EmptyStarType> = ({className, classNameSvg}) => (
        <div  className={className ? `${styles.star} ${className}`: styles.star}>
